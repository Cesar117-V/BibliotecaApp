        ...
        child: SingleChildScrollView(
          ...
          child: Wrap(
            ...
            children: const [
              ...
              BotonAnimadoAdmin(
                titulo: "Gestión de Bibliotecarios",
                icono: Icons.manage_accounts,
                pagina: GestionBibliotecariosScreen(),
              ),
              BotonAnimadoAdmin(
                titulo: "Gestión de Trabajadores",
                icono: Icons.people_alt,
                pagina: GestionTrabajadoresScreen(),
              ),
              BotonAnimadoAdmin(
                titulo: "Préstamos",
                icono: Icons.assignment_return,
                pagina: PrestamosTabScreen(),
              ),
              BotonAnimadoAdmin(
                titulo: "Devoluciones",
...
class BotonAnimadoAdmin extends StatefulWidget {
  final String titulo;
  final IconData icono;
  final Widget pagina;

  const BotonAnimadoAdmin({
    Key? key,
  ...
  @override
  State<BotonAnimadoAdmin> createState() => _BotonAnimadoAdminState();
}

class _BotonAnimadoAdminState extends State<BotonAnimadoAdmin> {
  bool _hover = false;
